...
let Root: React.FC<ComponentProps> = () => {
    ...
    return (
        <MyThemeProvider>
            <GlobalStyles />
            {!moduleLoaded && (
                <Grid container justifyContent="space-between" direction="column" alignContent="center" style={{ height: '100vh' }}>
                    <Typography variant="h1" align="center">
                        DIMAKA
                    </Typography>
                    <Grid item container justifyContent="center" alignItems="center" direction="column" spacing={3}>
                    ...
                    <Typography variant="body2" align="right" color="textSecondary">
                        BUILT {import.meta.env.SNOWPACK_PUBLIC_BUILD_DATE}
                    </Typography>
                </Grid>
            )}
